...
[ApiController]
[Route("stacks/{stackId:guid}/tenants/{tenantId:guid}/branches/{branchId:guid}/assets")]
public class AssetsController : ControllerBase
{
    ...
    [HttpGet]
    public async Task<ActionResult<IEnumerable<Asset>>> GetAssets(Guid stackId, Guid tenantId, Guid branchId)
    {
    ...
    public async Task<ActionResult<Asset>> GetAsset(Guid stackId, Guid tenantId, Guid branchId, Guid assetId)
    {
    ...
    [HttpPost]
    public async Task<ActionResult<Asset>> CreateAsset(Guid stackId, Guid tenantId, Guid branchId, [FromBody] CreateAssetRequest request)
    {
        ...
        return CreatedAtAction(nameof(GetAsset), new { stackId, tenantId, branchId, assetId = asset.Id }, asset);
    }

    [HttpPut("{assetId:guid}")]
    public async Task<ActionResult> UpdateAsset(Guid stackId, Guid tenantId, Guid branchId, Guid assetId, [FromBody] UpdateAssetRequest request)
    {
    ...
    public async Task<ActionResult> DeleteAsset(Guid stackId, Guid tenantId, Guid branchId, Guid assetId)
    {
